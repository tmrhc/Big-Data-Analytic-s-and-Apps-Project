    ...
    BroadcastReceiver receiver = new BroadcastReceiver() {
 		...
 		public void onReceive(Context context, Intent intent) {
 			...
 			if (bundle!=null) {
 				...
 				String directiony = bundle.getString("y");
 				Float daty = Float.valueOf(directiony);
	 				...
	 				else
	 				{
	 					...
	 					else
	 					{
	 						...
	 						else
	 						{
	 							if(count == 10)
	 							{
	 								mSnakeView.updateWithSensor(directionx, directiony, dataz);
	 								count++;
 				...
 				else if(verthoriz == 1)
 				{
 					if(count==0)
	 				{
	 					count++;
	 					storeing = datay;
	 					Log.i("Next check", "count==0");
	 				}
	 				else
	 				{
	 					if(count<10 && storeing == datay)
	 					{
	 						count++;
	 						Log.i("Next check", "count<10 && storeing == data");
	 					...
	 					else
	 					{
	 						...
	 						else
	 						{
	 							if(count == 10)
	 							{
	 								...
	 								mSnakeView.updateWithSensor(directionx, directiony, dataz);
	 								count++;
	 								Log.i("Next Direction update", "count == 10");
	 								verthoriz = 0;
	 							}
	 							else
	 							{
	 								...
	 								{
	 									count=0;
	 									Log.i("Next check", "storeing != data");
	 								}
	 								else
	 								{
	 									count++;
	 									Log.i("Next check", "count++");
